...
public class calculator extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet calculator at "+ "</h1>");
            
            out.println("<h2>Culator Add (15 + 15) = " + add(15, 15) + "</h2>");
            out.println("<h2>Culator Divide (2 / 15) =   " + divide(2, 15) + "</h2>");
            out.println("<h2>Culator Multiply (100 * 15) =  " + multiply(100, 15) + "</h2>");
            out.println("<h2>Culator Subtract (90 - 15) = " + subtract(90, 15) + "</h2>");
