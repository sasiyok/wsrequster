 ...
 * @author 8402-01
 */
@WebServlet(name = "GradeCalculationServlet", urlPatterns = {"/GradeCalculationServlet"})
public class GradeCalculationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>GradeCalculationServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GradeCalculationServlet at " + request.getContextPath() + "</h1>");
